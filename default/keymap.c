...
[_LOWER] = LAYOUT(
    ...
    _______, _______, _______, KC_LT,   KC_GT,   KC_GRV,                      KC_LBRC,    KC_RBRC,    KC_AMPR,    KC_PIPE,    KC_CIRC,    KC_F12,
    _______,  KC_DLR, KC_AT,   KC_HASH, KC_EXLM, KC_QUES ,                   KC_LPRN, KC_RPRN, KC_PLUS, KC_PMNS, KC_PEQL, KC_TILD,
    _______, _______, KC_QUOT, KC_DQUO, KC_SCLN, KC_PERC, S(LALT(KC_ENT)), _______, KC_LCBR, KC_RCBR, KC_UNDS, KC_ASTR, KC_PSLS, KC_BSLS,
...
[_RAISE] = LAYOUT(
    ...
    KC_LCTRL,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   _______, _______,  KC_PLUS, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
                      _______, _______, _______, _______,  _______, _______,  _______, _______, _______, _______
),
...
[_ADJUST] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, S(LALT(KC_J)), S(LALT(KC_K)), S(LALT(KC_ENT)), XXXXXXX, XXXXXXX, XXXXXXX,
                      _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______
  )
};
